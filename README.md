...
| Для страницы выгрузки фото в БД повторить анализ файлов, как на Главной странице. |                                                        | Готовая к использованию и протестированная нейросеть на базе TensorFlow 1.4.0 |                                                              |
